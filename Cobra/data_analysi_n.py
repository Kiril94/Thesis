...
# In[number of sick patients in the healthy dirs]
pos_patients_id_set = set([os.path.split(dir_)[1] for dir_ in pos_patients_list])
common_patients = 18
for healthy_dir in healthy_dirs[2:]:
    healthy_id_set = set(os.listdir(healthy_dir))
    common_patients += len(pos_patients_id_set.intersection(healthy_id_set))
