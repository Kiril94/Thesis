...
vols_path = "/home/lkw918/cobra/data/cmb-3dcnn-data/nii"
masks_path = "/home/lkw918/cobra/data/cmb-3dcnn-data/masks"

slices_path = "/home/lkw918/cobra/data/cmb-3dcnn-data/slices"
...
for filename in filenames:
    ...
    for x in range(1,img.shape[0]-1):
        ...
        slice_name = f'{filename[:-4]}_slice{x}.nii.gz'
    ...
    for y in range(1,img.shape[1]-1):
        ...
        slice_name = f'{filename[:-4]}_slice{y}.nii.gz'
    ...
    for z in range(1,img.shape[2]-1):
        ...
        slice_name = f'{filename[:-4]}_slice{z}.nii.gz'
