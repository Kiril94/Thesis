...
print(f'For all population\n# CMBs = \t({cmbs_number_mean_all:.2f}+\-{cmbs_number_std_all:.2f})\nCMBs volume = \t({cmbs_volume_mean_all:.2f}+\-{cmbs_volume_std_all:.2f})')
#Values for <= 50 y.o.
...
print(f'For >=50 y.o. population\n# CMBs = \t({cmbs_number_mean_50:.2f}+\-{cmbs_number_std_50:.2f})\nCMBs volume = \t({cmbs_volume_mean_50:.2f}+\-{cmbs_volume_std_50:.2f})')
